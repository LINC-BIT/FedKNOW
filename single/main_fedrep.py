...
from models.Nets import RepTailResNet
...
if __name__ == '__main__':
    ...
    if 'cifar' in args.dataset or args.dataset == 'mnist' or 'miniimagenet' in args.dataset or 'FC100' in args.dataset or 'tinyimagenet' in args.dataset:
    ...
    for iter in range(args.epochs):
        ...
        if iter % args.round == args.round-1:
            ...
            model_save_path = './save/FedRep/0.4/accs_FedRep_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
    ...
    print(times)
    print(accs)
    base_dir = './save/FedRep/0.4/accs_FedRep_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
