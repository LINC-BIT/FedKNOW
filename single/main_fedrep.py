...
from single.ContinualLearningMethod.FedRep import Appr,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('./log/FedRep_' + args.dataset + '_' + 'round' + str(args.round) + '_frac' + str(
    ...
    print(times)
    print(accs)
    base_dir = './save/FedRep/accs_FedRep_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
