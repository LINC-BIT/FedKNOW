...
from single.ContinualLearningMethod.MAS import Appr,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('./log/MAS_' + args.dataset + '_' + 'round' + str(args.round) + '_frac' + str(
    ...
    print(times)
    print(accs)
    base_dir = './save/MAS/accs_MAS_lambda_' + str(args.lamb) + str( '_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
