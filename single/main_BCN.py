...
from single.ContinualLearningMethod.BCN import Appr,LongLifeTrain
...
if __name__ == '__main__':
    ...
    write = SummaryWriter('./log/BCN_' + args.dataset + '_' + 'round' + str(args.round) + '_frac' + str(
    ...
    print(times)
    print(accs)
    base_dir = './save/BCN/accs_BCN_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
