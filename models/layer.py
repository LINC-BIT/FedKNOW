...
# from_kb = torch.Tensor(200,100,5)
# print(from_kb.size(-1))
# # # c = DecomposedConv(3, 32, kernel_size=3,from_kb=from_kb, padding=1)
# # # x = torch.Tensor(100,3,32,32)
# # # d = c.forward(x)
# # # a = torch.Tensor(3,3,3,32)
# # # b = x = torch.randn(30)
# # # c=a*b
# # # print(c.shape)
# c = DecomposedLinear(100,200)
# c.set_knlwledge(from_kb)
# # c.set_atten(1,from_kb.size(-1))
# for name,i in c.named_parameters():
#     print(name+',')
# # x = torch.Tensor(100)
# # d = c.forward(x)